    ...
    while episode_idx < num_episodes:
        ...
        while (not time_step.last()) or step_count < minimal_episode_length:
            with torch.no_grad(), utils.eval_mode(expert_agent):
                ...
                if time_step.observation_wrist_rgb is not None:
                    wrist_rgb_arrays_sub.append(time_step.observation_wrist_rgb)
        ...
        if n_goal_achieved_total < 10.:
            ...
            wrist_rgb_arrays.extend(deepcopy(wrist_rgb_arrays_sub))
